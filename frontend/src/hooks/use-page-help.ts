...
const ROUTE_MAP: Array<{ pattern: RegExp; key: string }> = [
  ...
  { pattern: /^\/admin\/clients\/[^/]+$/, key: 'admin-client-detail' },
  { pattern: /^\/admin\/clients$/, key: 'admin-clients' },
  { pattern: /^\/admin\/base-connaissances\/[^/]+$/, key: 'admin-kb-article-detail' },
  { pattern: /^\/admin\/base-connaissances$/, key: 'admin-knowledge-base' },
  { pattern: /^\/admin\/feuilles-travail\/[^/]+$/, key: 'admin-worksheet-detail' },
  { pattern: /^\/admin\/feuilles-travail$/, key: 'admin-worksheets' },
  ...
  { pattern: /^\/portail\/feuilles-travail\/[^/]+$/, key: 'customer-worksheet-detail' },
  { pattern: /^\/portail\/feuilles-travail$/, key: 'customer-worksheets' },
  ...
  { pattern: /^\/technicien\/feuilles-travail\/[^/]+$/, key: 'tech-worksheet-detail' },
  { pattern: /^\/technicien\/feuilles-travail$/, key: 'tech-worksheets' },
