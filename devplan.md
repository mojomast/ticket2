...
- [ ] Phase 5: Wire admin pages (Dashboard, Tickets, KanbanBoard, Settings, Backups, Calendar, Clients, Technicians)
- [⏳] Phase 6: Wire technician pages (Dashboard, Tickets, TicketDetail, Schedule) — Dashboard ✅, Schedule ✅, Tickets ✅
- [⏳] Phase 7: Wire portal pages (Dashboard, Tickets, TicketDetail, Appointments, WorkOrders, WorkOrderDetail) — Dashboard ✅, Appointments ✅, WorkOrders ✅, WorkOrderDetail ✅, Tickets ✅
